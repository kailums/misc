...
$PROF python grouped_gemm_all_gpu.py --compare #--speed #--compare #--speed --fp16
#$PROF python grouped_gemm_gpu_map.py --fp16 --speed #--compare #--speed --fp16
#$PROF python grouped_gemm_cpu_map.py --fp16 --compare #--speed --fp16
