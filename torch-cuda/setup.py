...
ops_extension = CUDAExtension(
    name="cuda_ops",
    sources=["csrc/cuda_ops.cpp", "csrc/fused_attn_kernels.cu"],
    extra_compile_args={
        "cxx": CXX_FLAGS,
        "nvcc": NVCC_FLAGS,
    },
...
setuptools.setup(
    ...
    author="anyone",
    license="Apache 2.0",
    description=("A test for torch cuda ops"),
    classifiers=[
    ...
    packages=setuptools.find_packages(exclude=("csrc", "tests")),
    python_requires=">=3.8",
    ext_modules=ext_modules,
    cmdclass={"build_ext": BuildExtension},
    package_data={"cuda_ops": ["py.typed"]},
)
