...
PROF='/opt/nvidia/nsight-compute/2023.1.1/ncu -o gemm-dense-opted-4x4 -f --section ComputeWorkloadAnalysis --section InstructionStats --section LaunchStats --section MemoryWorkloadAnalysis --section MemoryWorkloadAnalysis_Chart --section MemoryWorkloadAnalysis_Tables --section NumaAffinity --section Occupancy --section SchedulerStats --section SourceCounters --section SpeedOfLight --section WarpStateStats   --import-source=yes --source-folders=.'
...
#PROF='/opt/nvidia/nsight-compute/2023.1.1/ncu --print-summary=per-kernel'
#PROF='/opt/nvidia/nsight-compute/2023.1.1/ncu -k Kernel --print-summary=per-kernel '
#PROF='compute-sanitizer '
